                            ...
                            <div class="card-header">
                                <h3 class="card-title">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('permission.reload') }}" class="btn btn-sm btn-warning"><i class="fas fa-sync-alt"></i> @lang('admin.Reload')</a>
                                    </div>
                                </h3>
                            </div>
                            @endcan

...
use Modules\Hospitals\Entities\Sick;
...
class SicksController extends Controller
{
    ...
    {
        $data = Sick::all();
        return view('hospitals::sicks.index',compact('data'));
    }
    ...
    {
        return view('hospitals::sicks.create');
    }
    ...
    {
        return view('hospitals::sicks.edit',compact('sick'));

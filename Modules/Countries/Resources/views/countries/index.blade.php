                                ...
                                <table class="table table-bordered table-hover datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>@lang('admin.City_Name')</th>
                                            <th>@lang('admin.Updated')</th>
                                            @canany(['update countries', 'delete countries'])
                                    ...
                                    <tbody>
                                        @foreach ($data as $i)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('cities.index') }}">{{ $i->name }}</a></td>
                                                <td>

                                                    <ul>
                                                        @foreach (Modules\Countries\Models\City::where('country_id',$i->id)->get() as $sp)
                                                        <li>{{ $sp->name }}</li>
                                                        @endforeach
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('countries.destroy') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
